...
node --env-file=.env -e '
  ...
  const args = [
    ...
    "-f", "supabase/migrations/20260726000550_add_llm_job_records.sql",
    "-f", "supabase/migrations/20260726000600_add_llm_job_inputs_and_pricing.sql",
    "-f", "supabase/migrations/20260726000700_reserve_llm_job_credit.sql",
    "-f", "supabase/migrations/20260726000800_settle_llm_job_credit.sql",
    "-f", "supabase/migrations/20260726000900_start_and_fail_llm_attempts.sql",
    "-f", "supabase/migrations/20260726001000_read_and_stream_llm_jobs.sql",
    "-f", "supabase/migrations/20260726001100_add_llm_performance_score.sql",
